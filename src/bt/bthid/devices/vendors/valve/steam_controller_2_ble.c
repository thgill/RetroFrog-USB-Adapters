...
// touch scale (see input_event.h). X passes straight; Y is inverted (SC2 +Y = up,
// but canonical 0 = top).
static inline uint16_t pad_x(int16_t v) { return touch_norm_from_s16(v); }
static inline uint16_t pad_y(int16_t v) { return (uint16_t)(32767 - (int32_t)v); }
